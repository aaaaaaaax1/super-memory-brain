...
if (Test-Path $HookPath) {
  ...
  Add-HookCheck 'Hook explicit Super Brain wake words' (($hookText -like '*explicit*') -and ($hookText -like "*$chineseSuperBrain*") -and ($hookText -like '*Super Brain*') -and ($hookText -like '*G1*') -and ($hookText -like '*load Skill super-memory-brain first*'))
  Add-HookCheck 'Hook explicit Super Brain triggers' (($hookText -like '*Super Brain*') -and ($hookText -like '*G1*') -and (($hookText -like '*status/fault/start/refresh*') -or ($hookText -like '*start/refresh*') -or ($hookText -like '*continue/fault/start/refresh*')))
  ...
  Add-HookCheck 'Hook silent memory auto' (($hookText -like '*memory:auto silent*') -and (($hookText -like '*no G1 for ok/chat/code*') -or (($hookText -like '*G1 only for explicit Super Brain*') -and ($hookText -like '*not ok/chat*'))))
