...
| Git repository maintenance | `maintenance_release` | Read maintenance reference; run direct Git/privacy readiness checks. |
...
- `references/maintenance-release.md`: direct Git maintenance and privacy readiness.
