...
## What This Source Module Contains

This source module is absorbed by Super Brain and contains:
...
The two upstream repositories and heavier reverse-engineering tools remain
optional local deployment dependencies. They are not bundled, independently
installed Codex skills, or part of a generated sharing package.
...
Use the Super Brain Git checkout directly. There is no export, share package,
or release clone. When this capability is needed, Super Brain routes to its
native procedure and asks before any external download, global MCP write, or
host-specific tool installation.
