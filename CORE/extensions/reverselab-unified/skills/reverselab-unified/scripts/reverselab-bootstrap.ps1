...
if ($Profile -eq 'Full') {
  Add-Action 'full-toolchain-note' 'Read references/install-and-deploy.md for full toolchain setup details.' 'full setup includes third-party GUI tools, network downloads, and tools that may require local GUI/path confirmation'
