...
THREAD_ID = "super-brain-recall-quality-diagnostic"
        ...
        json.dumps(
            {
                ...
                "status": "active",
                "revision": 1,
                "focusId": "diagnostic-recall-line",
                "focusLabel": "Recall diagnostic task",
                ...
                "planReceipt": {
                    "focusId": "diagnostic-recall-line",
                    "contractRevision": 1,
                    "planFingerprint": "diagnostic-recall-fixture",
                },
                "updatedAt": updated_at,
            }
        ),
...
def result_id(source: str, line_ids: dict[int, str], graph_ids: dict[int, str]) -> str:
    if source == "memory\\workspace\\runtime-state\\execution-contracts":
        return "task-current"
