...
- Before advancing a formal implementation phase, run the smallest real user
  path and a relevant counterexample. A local command success, static review,
  or generated file alone is not phase completion; record the observed
  artifacts through the governed phase-closeout path before reporting progress.
