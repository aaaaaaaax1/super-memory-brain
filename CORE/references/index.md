...
| Automatic thread/plan wake, hot index, or skill/runtime ownership | `references/runtime-control-plane.md` | Full memory recall, prompt-level task-tree rules, or a second per-message hook |
...
| Phase 6 memory E2E evaluation | `references/phase6-memory-evaluation.md` | Treating diagnostic self-tests or internal acceptance as objective intelligence scores |
