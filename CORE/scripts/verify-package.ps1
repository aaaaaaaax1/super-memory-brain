...
if ($PackageOnly -and -not $Worker) {
  ...
  $checkDefinitions = @(
    ...
    [pscustomobject]@{ name='scope broker regression'; executable='python'; arguments=@('tests\runtime_scope_broker_regression.py') }
    [pscustomobject]@{ name='scope provider regression'; executable='python'; arguments=@('tests\runtime_scope_provider_regression.py') }
...
$required = @(
  ...
  'runtime\scope_broker.py','runtime\scope_provider.py','runtime\scope_broker_ipc.py','runtime\mcp_transport_health.py',
  ...
  'tests\runtime_scope_broker_regression.py','tests\runtime_scope_provider_regression.py','tests\runtime_scope_broker_ipc_regression.py','tests\runtime_mcp_scope_broker_integration_regression.py','tests\runtime_turn_scope_authorization_regression.py',
  ...
  'scripts\verify-package.ps1','scripts\auto-check.ps1','scripts\startup-check.ps1','scripts\first-load-bootstrap.ps1','scripts\retire-codex-super-brain-hooks.ps1','scripts\codex-user-prompt-hook.ps1','scripts\internal\verify-package-receipt.ps1','scripts\internal\hook-runtime-common.ps1','scripts\internal\codex-hook-host-state.ps1','scripts\internal\intent-resolution.ps1','scripts\internal\phase-closeout-core.ps1','scripts\internal\install-transaction.ps1','scripts\internal\memory-rewrite-transaction.ps1','scripts\internal\responses-api-bridge.ps1','scripts\install-codex-user-prompt-hook.ps1','scripts\install-codex-stop-hook.ps1','scripts\install-runtime.ps1','scripts\runtime-eval.ps1','scripts\mcp-process-audit.ps1','scripts\runtime-status.ps1','scripts\script-call-contract.ps1','scripts\update-state.ps1','scripts\state.ps1','scripts\recall-search.ps1','scripts\recall-recent.ps1','scripts\session-restore.ps1','scripts\session-binding.ps1','scripts\learn-memory.ps1','scripts\profile-card.ps1','scripts\user-adaptation.ps1','scripts\user-adaptation-observer.ps1','scripts\internal\user-adaptation-core.ps1','scripts\internal\runtime-wake-core.ps1','scripts\install-agent.ps1','scripts\hot-refresh-skills.ps1','scripts\install-menu.ps1','scripts\cleanup-legacy-memory.ps1','scripts\cleanup-install-backups.ps1','scripts\migrate-memory-layout.ps1','scripts\repair-hook.ps1','scripts\encoding-check.ps1','scripts\graph-normalize.ps1','scripts\write-decision.ps1','scripts\decision-search.ps1','scripts\decision-audit.ps1','scripts\bootstrap.ps1','scripts\graph-add.ps1','scripts\graph-search.ps1','scripts\extract-facts.ps1','scripts\phase6-memory-eval.ps1','scripts\phase6-answer-artifact-generator.ps1','scripts\objective-answer-artifact-generator.ps1','scripts\evaluation-learning-bridge.ps1',
...
${mcpTransportHealthText} = Read-Utf8 'runtime\mcp_transport_health.py'
${scopeBrokerRuntimeText} = Read-Utf8 'runtime\scope_broker.py'
${scopeProviderRuntimeText} = Read-Utf8 'runtime\scope_provider.py'
