...
$currentTaskContext = Get-SuperBrainCurrentTaskContext $workspace $WorkspaceKey
...
$privacy = [pscustomobject]@{ ok=$null; privatePatternHits=0 }
...
$result = [pscustomobject]@{
  ...
  privacy = [pscustomobject]@{ ok=$privacy.ok; privatePatternHits=$privacy.privatePatternHits }
