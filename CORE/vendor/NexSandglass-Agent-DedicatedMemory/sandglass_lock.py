    ...
    def acquire(self) -> int:
        ...
        while time.time() < deadline:
            ...
            try:
                ...
                # Windows can surface another process holding the lock file as
                # PermissionError instead of FileExistsError. It is normal
                # contention here, so keep the same bounded retry behavior.
